...
class UsersTable extends Table
{
    ...
    public function getLeaderBoardData($type=1, $limit=5){
        ...
        $leaderResultData['week']   = $this
                                    ->find()
                                    ->select(['Users.id','Users.username','Users.first_name','Users.last_name','Users.after_image','Users.image','Users.week_weight_loss_percent','Users.month_weight_loss_percent','Users.total_weight_loss_percent','Users.trainer_id','Users.leaderboard_show', 'Users.expire_date'])
                                    ->where(['Users.status_id' => ACTIVE_STATUS, 'Users.group_id' => CLIENTGROUPID, 'Users.leaderboard_show' => 1, 'Date(Users.expire_date) >=' => Date('y-m-d')])
