	...
	<div class="container">
		...
		<div class="middle-content message-content">
			...
			<div class="plans-container payment-container">
				...
				<?= $this->Form->input('gender',array('class' => 'form-control', 'options' => array(0 => 'Male',1 => 'Female'), 'templates' => ['inputContainer' => '<div class="col-6-1"><div class="form-row">{{content}}</div></div>'])); ?>
				...
				<?= $this->Form->input('meal_type',array('class' => 'form-control', 'value' =>$meal_details[0]['meal_type'], 'required', 'readonly', 'templates' => ['inputContainer' => '<div class="col-6-1"><div class="form-row">{{content}}</div></div>'])); ?>

				<?= $this->Form->input('activity_level',array('class' => 'form-control', 'value' =>$meal_details[0]['activity_level'], 'required', 'readonly', 'templates' => ['inputContainer' => '<div class="col-6-2"><div class="form-row">{{content}}</div></div>'])); ?>

				<?= $this->Form->input('wakeup_time',array('class' => 'form-control', 'value' =>$wakeup_time, 'label' => 'Wakeup Time', 'id'=>'timepicker', 'required', 'templates' => ['inputContainer' => '<div class="col-6-1"><div class="form-row">{{content}}</div></div>'])); ?>
