<div class="main row">
	<div class="container">
		<div class="payment-process">
            ...
            <input type="hidden" name="cancel_return" value="https://www.foodfuels.com/users/pay_me/<?php echo $Subscriptions['id'] ?>">
            <input type="hidden" name="return" value="https://www.foodfuels.com/users/logout">
    ...
    font-size: 20px;"/>
			...
			<div class="plans-container payment-container" style="display:none;" id="creditCardForm">
				...
				<div class="row center-align mrg-40">
					<?= $this->Form->submit('Complete Payment',['class' => 'green-btn']); ?>
				</div>
				<?= $this->Form->end(); ?>
			</div>
		</div>
