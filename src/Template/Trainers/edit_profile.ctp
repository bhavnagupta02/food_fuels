<?php 
	echo $this->Html->css(array('bootstrap.min','cropper','main','jquery-ui-redmond.min.css'));

	echo $this->Html->script(array('bootstrap.min','cropper','cropmain','common','jquery.ajax_form','ckeditor/ckeditor'));
	...
	<div class="container">
		<div class="payment-process">
			...
			<div class="plans-container payment-container">
				...
				<?= $this->Form->input('dob',array('class' => 'form-control', 'value' => Date('Y-m-d',strtotime($this->request->data['dob'])), 'label' => 'Date Of Birth', 'required', 'templates' => ['inputContainer' => '<div class="col-6-2"><div class="form-row">{{content}}</div></div>'])); ?>
				
				<?= $this->Form->input('gender',array('class' => 'form-control', 'options' => array(0 => 'Male',1 => 'Female'), 'templates' => ['inputContainer' => '<div class="form-row">{{content}}</div>'])); ?>

				<?= $this->Form->input('short_description',array('class' => 'form-control height75px','type' => 'textarea', 'placeholder'=> 'Tell Us About Yourself', 'maxlength' => 160, 'templates' => ['inputContainer' => '<div class="form-row">{{content}}</div>'])); ?>

				<?= $this->Form->input('achievements',array('class' => 'form-control height75px ckeditor','maxlength' => 550,'id' => 'ckeditor','type' => 'textarea', 'templates' => ['inputContainer' => '<div class="form-row">{{content}}</div>'])); ?>
